...
import { thunkAllCollections, thunkRemoveCollection } from "../../redux/collection";
        ...
        <div className="landing-explore">
            ...
            <div className="grid-container">
                {collections.map(collection => (
                    <div key={collection.id} id="itinerary-manage-grid-item" className="manage-item">
                        <Link to={`/itineraries/${collection.itinerary.id}`}>
                        <div className="image-container"><img src={collection.itinerary.preview_image_url} alt={collection.itinerary.title}/></div>
                        </Link>
                        ...
                        <div className="owner-selection">
                            <button onClick={() => handleDeleteClick(collection.itinerary_id)}>Remove</button>
                        </div>
                    </div>
                ))}
            </div>
            : <div>You have not collected any itineraries yet. Explore and collect inspiring itineraries from other travelers!</div>}
        </div>
